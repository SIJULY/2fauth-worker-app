          ...
          <el-collapse>
            <el-collapse-item :title="$t('tools.advanced_settings')" name="1">
              <div class="advanced-row">
                <el-select v-model="algorithm" @change="updateUri" :placeholder="$t('tools.totp_algorithm')" style="flex: 1">
                ...
                <el-select v-model="digits" @change="updateUri" :placeholder="$t('tools.totp_digits')" style="width: 100px">
                  <el-option :label="$t('vault.digits_6')" :value="6" />
                  <el-option :label="$t('vault.digits_8')" :value="8" />
                </el-select>
                <el-select v-model="period" @change="updateUri" :placeholder="$t('tools.totp_period')" style="width: 100px">
