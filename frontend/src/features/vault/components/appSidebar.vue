<template>
  ...
  <el-aside :width="isCollapse ? '64px' : '240px'" class="left-aside" v-if="!layoutStore.isMobile">
    ...
    >
      ...
      <!-- 拆分后的 4 个独立工具一级菜单 -->
      <el-menu-item index="tool-totp">
        <el-icon><Lock /></el-icon>
        <template #title><span>TOTP 密钥工具</span></template>
      </el-menu-item>
      <el-menu-item index="tool-password">
        <el-icon><Key /></el-icon>
        <template #title><span>密码生成器</span></template>
      </el-menu-item>
      <el-menu-item index="tool-time">
        <el-icon><Timer /></el-icon>
        <template #title><span>时间校准器</span></template>
      </el-menu-item>
      <el-menu-item index="tool-qr">
        <el-icon><FullScreen /></el-icon>
        <template #title><span>二维码解析器</span></template>
      </el-menu-item>
    </el-menu>
  ...
  >
    <div class="drawer-content">
      ...
      >
        ...
        <!-- 拆分后的 4 个独立工具一级菜单 (移动端) -->
        <el-menu-item index="tool-totp">
          <el-icon><Lock /></el-icon><span>TOTP 密钥工具</span>
        </el-menu-item>
        <el-menu-item index="tool-password">
          <el-icon><Key /></el-icon><span>密码生成器</span>
        </el-menu-item>
        <el-menu-item index="tool-time">
          <el-icon><Timer /></el-icon><span>时间校准器</span>
        </el-menu-item>
        <el-menu-item index="tool-qr">
          <el-icon><FullScreen /></el-icon><span>二维码解析器</span>
        </el-menu-item>
      </el-menu>
